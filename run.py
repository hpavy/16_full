...
class RunSimulation():
    ...
    def run(self):
        ...
        # Data loading
        X_train_np, U_train_np, X_full, U_full, X_border_np, mean_std = charge_data(self.hyper_param, self.param_adim)
        ...
        X_border = torch.from_numpy(X_border_np).requires_grad_().to(torch.float32).to(self.device)
